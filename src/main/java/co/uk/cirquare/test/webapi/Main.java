package co.uk.cirquare.test.webapi;
...
import co.uk.cirquare.test.webapi.app.Application;
...
public class Main {
    ...
    public static HttpServer startServer() {
        ...
        final Application app = new Application("co.uk.cirquare.test.webapi", getHost(), getPort());
    ...
    public static void main(String[] args) throws IOException {
        ...
        logger.info("co.uk.cirquare.test.webapi starting on port 8080... Ctrl-C to cancel");
